...
<body>
	<div id="Accordion1" class="Accordion">
		<?php foreach($menu_type as $menutype=>$menuname){ ?>
			<div class="AccordionPanel">
				<div class="AccordionPanelTab"><?php echo $menuname ?></div>
	...
	<div style="height:20px; margin-top:10px;"><span style="margin-left:35px; font-size:11px;">程序版本：v<?php echo $version ?></span></div>
