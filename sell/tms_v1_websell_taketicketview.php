...
<body>
	...
	<div style="margin-left:5px;">
		...
		<input type="text" name="safeUserIDCardIn" id="safeUserIDCardIn" size="20" value="<?php echo $safeUserIDCard?>" <?php echo $readonly?> style="height:20;"/>
	<!-- 
	...
	?>
		...
		&nbsp;&nbsp;<input type="button" name="cancelsell" id="cancelsell" style="height:18;text-align:center;font-size:12px;" value="取 消" <?php echo $subcancelenable?> onclick="window.location.assign('tms_v1_websell_taketicket.php');"/>
	</div>
	<br/><br/>
	...
	?>
		...
		<?php if ($isAllTicket == "0") {?>
			<td align="center"><?php echo $seatArray[$i]?></td>
		<?php } else {?>	
	...
	?>
		...
		<?php if ($isAllTicket == "0") {?>
			<td align="center"><?php echo $seatArray[$i+$tnum]?></td>
		<?php } else {?>	
			<td align="center"><?php echo XX?></td>
		<?php }?>	
			<td align="center"><?php echo $busModel?></td>
