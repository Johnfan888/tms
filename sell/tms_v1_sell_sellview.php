...
<input type="text" name="departuredate" id="departuredate" size="10" value="<?php echo $norunsdate?>" readonly="readonly" style="height:18;border:none"/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../ui/images/sj.gif" width="6" height="7" />&nbsp;发车时间：
<input type="text" name="departuretime" id="departuretime" size="5" value="<?php echo $norunstime?>" readonly="readonly" style="height:18;border:none"/>
<span style="font-size:16">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $fromplace?>&nbsp;&nbsp;&nbsp;<img src="../ui/images/sellarrow.gif" width="24" height="7" /></span>
<input type="hidden" name="fromstation" id="fromstation" value="<?php echo $fromplace?>" readonly="readonly" />
<span style="font-size:16">&nbsp;&nbsp;&nbsp;<?php echo $reachplace?></span>
<input type="hidden" name="reachstation" id="reachstation" size="10" value="<?php echo $reachplace?>" readonly="readonly" />
<span style="font-size:14">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;票价：<?php echo $fullPrice?></span>
<input type="hidden" name="fullPrice" id="fullPrice" size="7" value="<?php echo $fullPrice?>" readonly="readonly" />
<input type="hidden" name="busModel" id="busModel" size="10" value="<?php echo $busModel?>" readonly="readonly" />
<input type="hidden" name="isAllTicket" id="isAllTicket" size="2" value="<?php echo $isAllTicket?>" readonly="readonly" />
<input type="hidden" name="noofrun" id="noofrun" value="<?php echo $noofrunsID?>" readonly="readonly" />
</div>
<br/>
<div style="margin-left:5px;">
	<img src="../ui/images/sj.gif" width="6" height="7"/>&nbsp;全票数：
	<input type="text" name="fullTicketNumIn" id="fullTicketNumIn" size="2" value="<?php echo $tnum;?>" <?php echo $readonly?> style="height:20;" onkeyup="return isnumber(this.value)" onfocus="this.select()"/>
	&nbsp;&nbsp;&nbsp;<img src="../ui/images/sj.gif" width="6" height="7" />&nbsp;半票数：
	<input type="text" name="halfTicketNumIn" id="halfTicketNumIn" size="2" value="<?php echo $htnum;?>" <?php echo $readonly?> style="height:20;" onkeyup="return isnumber1(this.value)" onfocus="this.select()"/>
	...
	<input type="text" name="safeUserIDCardIn" id="safeUserIDCardIn" size="18" value="<?php echo $safeUserIDCard?>" <?php echo $readonly?> style="height:20;"/>
<!-- 
	&nbsp;<input type="button" name="readIDCard" id="readIDCard" style="font-size:13px;"value="读卡" onclick="readCard();document.getElementById('safeUserIDCardIn').focus();" <?php echo $viewenable?> />
-->
...
?>
	...
	<input type="hidden" name="totalticketnum" id="totalticketnum" size="3" value="<?php echo $totalticketnum?>" readonly="readonly" />
	<input type="hidden" name="totalsafenum" id="totalsafenum" size="3" value="<?php echo $totalinsureticketnum?>" readonly="readonly" />
	<input type="hidden" name="totalticketmoney" size="7" id="totalticketmoney" value="<?php echo $totalticketmoney?>" readonly="readonly" />
	<input type="hidden" name="totalsafemoney" id="totalsafemoney" size="3" value="<?php echo $totalinsureticketmoney?>" readonly="readonly" />
	...
	<input type="text" name="realticketmoney" id="realticketmoney" size="5" value="<?php echo ($totalmoney-$remainMoney)?>" readonly="readonly" style="height:22;border:none;color:RED;font-size:22"/>
	<br/><br/>
	...
	&nbsp;&nbsp;<input type="button" name="confirmsell" id="confirmsell" style="height:18;text-align:center;font-size:12px;" value="确 认 出 票" <?php echo $subcancelenable?> />&nbsp;&nbsp;&nbsp;&nbsp;
   	&nbsp;&nbsp;<input type="button" name="cancelsell" id="cancelsell" style="height:18;text-align:center;font-size:12px;" value="取 消" <?php echo $subcancelenable?> />
</div>
<br/><br/>
...
?>
	...
	<?php if ($isAllTicket == "0") {?>
		<td align="center" onclick="selectSeat(this);" ondblclick="selectSeat(this);"><?php echo $seatArray[$i]+1?></td>
	<?php } else {?>	
...
?>
	<tr style="background-color:#CCCCCC">
		<td align="center"><?php echo $i+$tnum+1?></td>
		<td align="center"><?php echo $norunsdate?></td>
		<td align="center"><?php echo $norunstime?></td>
		<td align="center"><?php echo $fromplace?></td>
		<td align="center"><?php echo $reachplace?></td>
	...
	<?php if ($isAllTicket == "0") {?>
		<td align="center" onclick="selectSeat(this);" ondblclick="selectSeat(this);"><?php echo $seatArray[$i+$tnum]+1?></td>
	<?php } else {?>	
		<td align="center"><?php echo XX?></td>
	<?php }?>	
		<td align="center"><?php echo $busModel?></td>
...
<?php if ($isAllTicket == "0") {?>
<iframe id="seatview" name="seatview" width="100%" height="100" frameborder="1" scrolling="yes" src="tms_v1_sell_seatview.php?nrID=<?php echo $noofrunsID?>&nrDate=<?php echo $norunsdate?>"></iframe>
<?php }?>
...
<div style="margin-left:5px;">
	...
	<input type="text" name="newTicketID" id="newTicketID" size="10" value="<?php echo $newTicketID?>" readonly="readonly" style="height:18;border:none"/>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../ui/images/sj.gif" width="6" height="7" />&nbsp;保险票号：
	<input type="text" name="newSafeTicketID" id="newSafeTicketID" size="10" value="<?php echo $newSafeTicketID?>" readonly="readonly" style="height:18;border:none"/>
...
&nbsp;&nbsp;&nbsp;<input type="button" name="sellview" id="sellview" style="height:18;text-align:center;font-size:12px;" value="售 票 预 览" <?php echo $viewenable?> />
</div>
<br/>
<div id="showIDs" style="margin-left:5px;">
	<img src="../ui/images/sj.gif" width="6" height="7" />&nbsp;所有身份证号：
	<input type="text" name="safeUserIDCards" id="safeUserIDCards" size="200" value="<?php echo $safeUserIDCards?>" style="height:18;border:none" />
	<input type="hidden" name="safeUsers" id="safeUsers" size="200" value="<?php echo $safeUsers?>" style="height:18;" />
	<input type="hidden" name="safeUserAddresses" id="safeUserAddresses" size="200" value="<?php echo $safeUserAddresses?>" style="height:18;" />
</div>
</form>
</body>
</html>
